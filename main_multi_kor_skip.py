...
img_onemore = Image.open("onemore.bmp")
img_onlycon = Image.open("onlycon.bmp")
...
img_area1 = Image.open("area1.bmp")
...
def gacha(tm, rst):
    ...
    while 1:
        ...
        while 1:
            ...
            if clickhere is not None:
                randsleep(0.1, 0.3)
                clickd(512, 489, 622, 510)
                print("OK")
                break
        print("More gacha", end="....")
        while 1:
            randsleep(0.1, 0.3)
            clickd(849, 55, 920, 75)
            scr_img = background_screenshot(bluestackhw, 960, 572)
            clickhere = pyautogui.locate(img_onemore, scr_img, confidence=0.8)
            if clickhere is not None:
                randsleep(0.1, 0.3)
                clickd(583, 373, 635, 403)
                print("OK")
                break
            clickhere = pyautogui.locate(img_onlycon, scr_img, confidence=0.8)
            if clickhere is not None:
...
def resetmara():
    ...
    #         break
    # print("OK")
    print("press backkey", end="....")
    while 1:  # touch robi he
        randsleep(0.4, 0.5)
        adbdevice.shell("input keyevent 158")
        scr_img = background_screenshot(bluestackhw, 960, 572)
        clickhere = pyautogui.locate(img_area1, scr_img, confidence=0.8)
